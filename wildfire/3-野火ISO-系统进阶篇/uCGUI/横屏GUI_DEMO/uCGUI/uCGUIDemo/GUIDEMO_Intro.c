...
void GUIDEMO_Intro(void) {
  ...
  GUI_DispStringHCenterAt("wildfire team", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 40);
//  GUI_DrawBitmap(&bmpsu, (LCD_GET_XSIZE() - bmpsu.XSize) / 2, 150);
  GUI_SetColor(GUI_WHITE);
  GUI_SetFont(&GUI_Font10S_ASCII);
  GUI_DispStringAt("GUI_OS: ", 0,LCD_GET_YSIZE()-30); GUI_DispDecMin(GUI_OS);
  GUI_DispStringAt("GUI_ALLOC_SIZE: ",0, LCD_GET_YSIZE()-20); GUI_DispDecMin(GUI_ALLOC_SIZE);
...
void GUIDEMO_Intro(void) {
  ...
  GUI_Clear();
//  GUI_DrawBitmap(&bmpsu, (LCD_GET_XSIZE() - bmpsu.XSize) / 2, 6);
  GUI_SetFont(&GUI_Font13B_1);
  GUI_DispStringHCenterAt("Eric2013", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 50);
  GUIDEMO_Delay(5000);
