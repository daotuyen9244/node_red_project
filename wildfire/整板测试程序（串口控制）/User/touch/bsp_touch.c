 ...
 */
static void Touch_GetAdXY(int *x,int *y)  
{ 
    int adx,ady; 
    //adx=Read_X();
...
*********************************************************/    
#if 0
static Coordinate *Read_2046(void)
{
...
*********************************************************/    
static Coordinate *Read_2046_2(void)
{
...
*********************************************************/    
static void Palette_draw_point(uint16_t x, uint16_t y)
{
  /* 画笔默认为黑色 */
