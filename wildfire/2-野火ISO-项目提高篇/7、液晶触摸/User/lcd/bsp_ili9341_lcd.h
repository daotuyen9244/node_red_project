...
#define Bank4_LCD_C    ((u32)0x6C000000)	   //Disp Reg ADDR
#define Bank4_LCD_D    ((u32)0x6D000000)       //Disp Data ADDR       // A23 PE2

/*选定LCD指定寄存器*/
#define LCD_WR_REG(index)    ((*(__IO u16 *) (Bank4_LCD_C)) = ((u16)index))
/*往LCD GRAM写入数据*/
#define LCD_WR_Data(val)       ((*(__IO u16 *) (Bank4_LCD_D)) = ((u16)(val)))
