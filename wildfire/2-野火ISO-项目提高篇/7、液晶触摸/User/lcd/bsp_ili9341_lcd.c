...
{	
	...
	R = *(__IO uint16_t *)Bank4_LCD_D; 	  /*FIRST READ OUT DUMMY DATA*/
	R = *(__IO uint16_t *)Bank4_LCD_D;  	/*READ OUT RED DATA  */
	B = *(__IO uint16_t *)Bank4_LCD_D;  	/*READ OUT BLACK DATA*/
	G = *(__IO uint16_t *)Bank4_LCD_D;  	/*READ OUT GREEN DATA*/
