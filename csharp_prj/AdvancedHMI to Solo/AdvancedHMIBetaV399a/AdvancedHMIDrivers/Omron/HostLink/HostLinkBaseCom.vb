...
#Region "Subscription"
        ...
        Private Sub PollUpdate(ByVal so As Object)
            ...
            While i < PolledAddressList.Count And i < ItemCountToUpdate
                ...
                If i < ItemCountToUpdate AndAlso (PollCounts / PolledAddressList(i).PollRateDivisor) = Convert.ToInt32(PollCounts / PolledAddressList(i).PollRateDivisor) Then
                    ...
                    Try
                        ...
                        While (i + j + 1) < ItemCountToUpdate AndAlso _
                            ...
                            ((PolledAddressList(i + j + 1).Address.ElementNumber + PolledAddressList(i + j + 1).Address.NumberOfElements) - PolledAddressList(i).Address.ElementNumber) < 25 AndAlso _
                            PolledAddressList(i + j).Address.BitsPerElement = PolledAddressList(i + j + 1).Address.BitsPerElement
                    ...
                    Try
                        ...
                        If PolledAddressList(i).Address.BitsPerElement = 1 Then
                            PolledAddressList(i).Address.NumberOfElements += PolledAddressList(i).Address.BitNumber
                            PolledAddressList(i).Address.NumberOfElements = 16
                        End If
                        Dim ReadAddress As New MfgControl.AdvancedHMI.Drivers.Omron.OmronPlcAddress(PolledAddressList(i).Address.Address, ElementsToRead)
