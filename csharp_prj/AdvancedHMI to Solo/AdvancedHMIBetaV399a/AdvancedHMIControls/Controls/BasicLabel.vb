...
#Region "PLC Related Properties"
    ...
    'Private m_PLCAddressValue2 As New AdvancedHMIDrivers.PLCAddressItem
    '<System.ComponentModel.Category("PLC Properties")> _
    'Public Property PLCAddressValue2() As AdvancedHMIDrivers.PLCAddressItem
    '    Get
    '        Return m_PLCAddressValue2
    '    End Get
    '    Set(value As AdvancedHMIDrivers.PLCAddressItem)
