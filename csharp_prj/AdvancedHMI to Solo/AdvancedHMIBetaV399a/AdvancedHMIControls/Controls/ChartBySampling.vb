...
<System.ComponentModel.TypeConverter(GetType(MfgControl.AdvancedHMI.Controls.AutoToDoubleTypeConverter(Of Double)))> _
    ...
    Private m_PLCAddressItems As List(Of AdvancedHMIDrivers.PLCAddressItem)
    <System.ComponentModel.DesignerSerializationVisibility(System.ComponentModel.DesignerSerializationVisibility.Content)> _
    Public ReadOnly Property PLCAddressItems As List(Of AdvancedHMIDrivers.PLCAddressItem)
        Get
...
#Region "Constructor"
    Public Sub New()
        ...
        m_PLCAddressItems = New List(Of AdvancedHMIDrivers.PLCAddressItem)
        ...
        If Not DesignMode And IsHandleCreated And Not SubscriptionsCreated Then
            ...
            While index < m_PLCAddressItems.Count
                If Not String.IsNullOrEmpty(m_PLCAddressItems(index).PLCAddress) Then
                    SubScriptions.SubscribeTo(m_PLCAddressItems(index).PLCAddress, AddressOf PolledDataReturned, m_PLCAddressItems(index).PLCAddress)
                End If
                index += 1
            End While
